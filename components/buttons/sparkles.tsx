...
const Sparkles = ({ text = "Click me" }: { text: string }) => {
  ...
  const handleBtnClick = () => {
    ...
    animate([
      ...sparkleReset,
      [".letter", { y: -32 }, { duration: 0.2, delay: stagger(0.05) }] as const,
      ["button", { scale: 0.8 }, { duration: 0.1, at: "<" }] as const,
      ["button", { scale: 1 }, { duration: 0.1 }] as const,
      ...sparkleAnimation,
      [".letter", { y: 0 }, { duration: 0.00000000001 }] as const,
      ...sparklesFadeOut,
    ]);
  };
  return (
